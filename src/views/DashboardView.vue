    ...
    <div class="dashboard__card">
      ...
      <form class="dashboard__form" @submit.prevent="handleSubmit">
        ...
        <input
          ...
          :disabled="loading"
        />
        <button type="submit" class="dashboard__button" :disabled="!nickname.trim() || loading">
          {{ loading ? "儲存中..." : "確認" }}
        </button>
      </form>
      ...
      <button type="button" class="dashboard__logout" @click="handleLogout" :disabled="loading || loadingLogout">
